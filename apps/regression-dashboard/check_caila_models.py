#!/usr/bin/env python3
"""Check which CAILA models are available with your API key.

Usage:
    python check_caila_models.py

This will check each model from the candidate list and show which ones work.
Note: Not a pytest test file - this is a standalone diagnostic script.
"""
import asyncio
import os
import sys
...
async def main():
    ...
    async with httpx.AsyncClient() as client:
        ...
        for model_id, display_name in CANDIDATE_MODELS:
            print(f"Checking {model_id:30} ", end="", flush=True)
